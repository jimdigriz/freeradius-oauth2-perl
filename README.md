 ...
 * xlat support to pull any URL with a suitable token and use [JSONPath](http://jsonpath.curiousconcept.com/) to extract data; backed by a simple HTTP cache

There is an [ISSUES](ISSUES.md) for the project listing outstanding problems and missing functionality.
